...
const postRefreshToken = (email, resfresh_token) => {
    return axios.post('/api/v1/refresh-token', { email, resfresh_token });
}
export {
    ...
    postAssignQuiz, getQuizWithQA, postUpserQA, getDashboard, postRefreshToken
}