...
const ModalViewUser = (props) => {
    const { show, setShow, dataUpdate, resetUpdateDate, handleCLickBtnUpdate } = props;
    ...
    // const hanldeUpdate = (dataUpdate) => {
    //     handleCLickBtnUpdate(dataUpdate);
    //     resetUpdateDate();
    //     handleClose();
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose} size={"xl"} className='modal-add-user'>
                ...
                <Modal.Body>
                    <form className="row g-3">
                        ...
                        <div className="col-md-4">
                            ...
                            <select className="form-select" value={role} onChange={(event) => setRole(event.target.value)} disabled={true}>
                ...
                <Modal.Footer>
                    ...
                    {/* <Button variant="primary" onClick={() => hanldeUpdate(dataUpdate)}>
                        Update
                    </Button> */}
                </Modal.Footer>
            </Modal>
