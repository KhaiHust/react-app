...
import { getQuizWithQA, getAllQuizForAdmin, postCreateNewQAnswerForQuestion, postCreateNewQuestionForQuiz, postUpserQA } from '../../../../services/apiServices';
        ...
        if (res && res.EC === 0) {
            ...
            for (let i = 0; i < res.DT.qa.length; i++) {
                ...
                if (q.imageFile) {
                    ...
                    q.imageFile = urltoFile(`data:text/plain;base64,${q.imageFile}`, `Question-${q.id}`, 'image/png')
                }
                newQA.push(q);
            }
            setQuestions(newQA);
                                        ...
                                        return (
                                            <div key={answer.id} className='answers-content'>
                                                ...
                                                <FloatingLabel
                                                    ...
                                                    label={
                                                        answer.description ? answer.description : `Answer ${index + 1}`
                                                    }
